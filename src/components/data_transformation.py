...
class DataTransformation:
    ...
    def get_data_transformation_object(self) -> Pipeline:
        logging.info("Entered get_data_transformation_object method of Data Transformation class")
        try:
            ...
            logging.info("Column loaded from schema.")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logging.info("Train_Test data loaded.")
